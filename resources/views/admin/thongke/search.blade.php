            ...
            <table class="adminTable mt-3" border="1">
                <tr>
                   <th>Stt</th>
                    ...
                    <th>Tên học sinh</th>
                    <th class="rowNone">Niên khóa</th>
                    <th class="rowNone">Lớp</th>
                    <th>Học lực</th>
                    <th class="rowNone">Nhận xét</th>
                ...
                @foreach ($solienlac as $item)
                  <tr>
                        ...
                        <td class="rowNone">{{$item->NienKhoa->NamBatDau . '- ' . $item->NienKhoa->NamKetThuc}}</td>
                        <td class="rowNone">{{$item->HocSinh->Hoc->where('id_nienkhoa', $item->NienKhoa->id)->first()->Lop->TenLop}}</td>
                        <td>
                            @if ($item->NhanXet->where('id_hocky', $hocky->id)->first())
                        ...
                        <td class="rowNone">
                            <a href="admin/thongke/{{$item->HocSinh->id}}?nienkhoa={{$item->NienKhoa->id}}" class="px-2 py-1 border-0 rounded modalBtn">
                                Xem chi tiết
                            </a>
                        </td>
                    </tr>
