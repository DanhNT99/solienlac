          ...
          <form action="{{route('searchPhuong')}}" class="adminFormSearch" method = "get">
              <table class="adminFormSeachTable">
                  <tr>
                      ...
                      <td>
                          <div class="formBoxSelect">
                              <select name="DonVi" class="formSelect">
                                  <option @if (Request::get('DonVi') == 'Xã') selected @endif value="Xã">Xã</option>
                                  <option @if (Request::get('DonVi') == 'Phường') selected @endif value="Phường">Phường</option>
                              </select>
                      ...
                      <td>
                          <input type="text" name="TenPhuong" value="{{Request::get('TenPhuong')}}" class="formInput capitalize" placeholder="Tên phường/xã">
                      </td>
                  </tr>
              </table>
...
<section class="adminList">
    <div class="container">
        ...
        <div class="adminActive">
            <a href="admin/phuong" class="adminActiveItem"><i class="fas fa-undo-alt"></i>Quay lại</a>
        </div>
