...
@section('adminContent')
    ...
    <section class="adminList">
        <div class="container">
            <h3 class="adminListTitle">Danh sach ban học</h3>
            <div class="adminActive">
                <a href="admin/banhoc/create" class="adminActiveItem"><i class="fas fa-plus-circle"></i>Thêm</a>
            ...
            <table class="adminTable" border="1">
                ...
                @foreach ($banhoc as $item)
                        <tr class = "trContainsBox">
                            ...
                            <td>{{$item->TenBH}}</td>
                            <td>
                                <a href="admin/banhoc/{{$item->id}}/edit">Chỉnh sửa</a>
